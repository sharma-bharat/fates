...
! =====================================================================================
  ...
  real(r8) function leafc_from_treelai( treelai, pft, c_area, nplant, cl, vcmax25top)
    ...
    !print*, 'sinkhole=======',trim(dateTimeString),treelai,slat,sla_max,c_area,nplant
    ...
    print*, 'sinkhole=======',leafc_from_treelai,treelai,slat,sla_max,c_area,nplant
  ...
  subroutine bfineroot(d,ipft,canopy_trim,l2fr,elongf_fnrt,bfr,dbfrdd)
    ...
    call get_curr_time_string(dateTimeString)  
    print*,'sinkhole_allometry_fr', trim(dateTimeString), bfr, elongf_fnrt, blmax, l2fr, canopy_trim  
    ! Reduce fine-root biomass due to phenology.
    bfr = elongf_fnrt * bfr
    if (present(dbfrdd)) then
       dbfrdd = elongf_fnrt * dbfrdd
    end if
    print*,'sinkhole_allometry_frEF', trim(dateTimeString), bfr, elongf_fnrt, blmax, l2fr, canopy_trim 
